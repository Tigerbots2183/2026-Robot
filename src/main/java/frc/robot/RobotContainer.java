...
public class RobotContainer {
    ...
    private s_Hood sHood = s_Hood.getInstance();
    private s_Turret sTurret = s_Turret.getInstance();
    private s_Shooter sShooter = s_Shooter.getInstance();
